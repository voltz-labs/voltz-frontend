...
export const PollCreate = () => {
  ...
  return (
    <Page title="Create Poll">
      <PageTitle>
        <PageTitleText>Create Poll</PageTitleText>
      </PageTitle>
      <PageContainer>
            ...
            <Col xs={12} md={6}>
              <Form.Group className="mb-3">
                <Form.Label htmlFor="expirationBlockQuote">
                  ...
                  {currentBlockQuote &&
                    ` (Current ${Intl.NumberFormat().format(
                      currentBlockQuote
                    )})`}
                </Form.Label>
                <Form.Control
                ...
                />
                <Form.Text className="text-muted">
                  The max block quote level allowed to votes to be casted, leave
                  it 0 to no expiration.
                </Form.Text>
              </Form.Group>
            </Col>
          </Row>
          <div className="mb-4">
            <h3 className="mb-2 border-bottom">Options</h3>
